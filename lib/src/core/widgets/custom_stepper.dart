      ...
      for (int i = 0; i < widget.steps.length; i += 1) ...<Widget>[
        const Row(
          children: <Widget>[
              ...
              // ),
            // Container(
            //   margin: const EdgeInsetsDirectional.only(start: 12.0, top: 2),
            //   decoration: BoxDecoration(borderRadius: BorderRadius.circular(8)),
            //   child: _buildHeaderText(i),
            //   color: Colors.grey[200],
            //   // color: _connectorColor(widget.steps[i].isActive),
            // ),
          ],
        ),
        if (!_isLast(i))
    ...
    return Column(
      children: <Widget>[
        Material(
          elevation: widget.elevation ?? 2,
          child: Container(
            margin: const EdgeInsets.only(left: 24.0, right: 24.0, top: Sizes.dimen_16 * 2, bottom: 2.0),
            child: Column(
              children: [
                Row(
